                ...
                <div class="col-lg-4-5">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p>Nous avons trouvé <strong class="text-brand">{{ count($vproduct) }}</strong> articles pour vous!</p>
                        </div>
 ...
 <p class="font-sm text-heading">{{ $vendor->vendor_short_info }}</p>
    ...
    <div class="vendor-info">
        <ul class="font-sm mb-20">
            <li><img class="mr-5" src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Addresse: </strong> <span>{{ $vendor->address }}</span></li>
            <li><img class="mr-5" src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Appel: </strong><span>{{ $vendor->phone }}</span></li>
        </ul>
