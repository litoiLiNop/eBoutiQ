...
<head>
    <meta charset="utf-8" />
    <title>eBoutiQ - Supermarchés en ligne au Cameroun</title>
        ...
        function productView(id){
            ...
            $.ajax({
                ...
                ///End Start Stock Option
                 ...
                 $('select[name="format"]').empty();
                 $.each(data.format,function(key,value){
                    $('select[name="format"]').append('<option value="'+value+' ">'+value+'  </option')
                    if (data.format == "") {
                        $('#formatArea').hide();
                    }else{
                         $('#formatArea').show();
...
/// End  Add To Cart Details Page Product
                            ...
                            <div class="product-rate-cover">
                                <div class="product-rate d-inline-block">
                                    ...
                                    <td class="price" data-title="Price">
                                        ${value.product.discount_price == null ? `<h3 class="text-brand">
                                            ${value.product.selling_price} Fcfa</h3>` :`<h3 class="text-brand">
                                                ${value.product.discount_price} Fcfa</h3>`}</td>
                                                <td class="text-center detail-info" data-title="Stock">
                                                    ${value.product.product_qty > 0
                                                ? `<span class="stock-status in-stock mb-0"> Disponible </span>`
                                                :`<span class="stock-status out-stock mb-0">Epuisé </span>`}</td>
...
<script type="text/javascript">
    ...
    <td class="row_img"><img src="/${value.product.product_thumbnail} " style="width:300px; height:300px;"  alt="compare-img" /></td>
                      ...
                      ${value.product.discount_price == null
                        ? `<h4 class="price text-brand">${value.product.selling_price} Fcfa</h4>`
                        :`<h4 class="price text-brand">${value.product.discount_price} Fcfa</h4>`
                                ...
                                :`<span class="stock-status out-stock mb-0">Epuisé </span>`
