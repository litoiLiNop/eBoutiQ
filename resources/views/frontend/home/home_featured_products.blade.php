            ...
            <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                <div class="banner-img style-2">
                    <div class="banner-text">
                        <h2 class="mb-100">Invitez aussi la nature chez vous</h2>
                        <a href="shop-grid-right.html" class="btn btn-xs">Achetez <i class="fi-rs-arrow-small-right"></i></a>
                    </div>
                </div>
            </div>
