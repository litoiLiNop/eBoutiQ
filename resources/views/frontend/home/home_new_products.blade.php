...
<a aria-label="Ajout aux favoris" class="action-btn" id="{{ $product->id }}" onclick="addToWishList(this.id)"  ><i class="fi-rs-heart"></i></a>
...
<!--end product card-->
    ...
    <h5 class="text-danger"> Aucun article trouvé </h5>
