...
@section('main')
 ...
 <p>Nous avons trouvé <strong class="text-brand">{{ count($products) }}</strong> articles pour toi!</p>
                        </div>
        ...
        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
            <div class="product-img-action-wrap">
                ...
                <div class="product-action-1">
                    ...
                    <a aria-label="Quickview" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="{{ $product->id }}" onclick="productView(this.id)"><i class="fi-rs-eye"></i></a>
                </div>
        ...
        <div class="single-post clearfix">
            ...
            <div class="content pt-10">
                <p><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}">{{ $product->product_name }}</a></p>
                   ...
                   @if($product->discount_price == NULL)
                    <p class="price mb-0 mt-5">{{ $product->selling_price }} F</p>
                   @else
                   <p class="price mb-0 mt-5">{{ $product->discount_price }} F</p>
                   @endif
