<header class="header-area header-style-1 header-height-2">
    <div class="mobile-promotion">
        <span>Grande ouverture, <strong>jusqu'à 15%</strong> sur tous les articles. <strong>3 jours</strong> encore</span>
    </div>
                ...
                <div class="col-xl-6 col-lg-4">
                    <div class="text-center">
                        <div id="news-flash" class="d-inline-block">
                            <ul>
                                <li>100% Livraison sécurisée sans avoir à contacter le livreur</li>
                                <li>Supper Offres de valeur - Economisez plus avec les coupons</li>
                                <li>Bijoux en argent à la mode, économisez + de 50% aujourd'hui</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<a href="{{ route('dashboard') }}"><span class="lable ml-0">Compte</span></a>
        <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
            <ul>
                <li>
                    <a href="{{ route('dashboard') }}"><i class="fi fi-rs-user mr-10"></i>Tableau de Bord</a>
                </li>
                <li>
