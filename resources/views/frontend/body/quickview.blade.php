...
<div class="attr-detail attr-size mb-20" id="sizeArea">
<strong class="mr-10" style="width:60px;">Taille: </strong>
...
<strong class="mr-10" style="width:60px;">Format: </strong>
 ...
 <div class="attr-detail attr-size mb-20" id="colorArea">
<strong class="mr-10" style="width:60px;">Couleur: </strong>
...
<input type="text" name="qty" id="qty" class="qty-val" value="1" min="1">
        ...
        <div class="product-extra-link2">
            ...
            <button type="submit" class="button button-add-to-cart" onclick="addToCart()"><i class="fi-rs-shopping-cart"></i>Ajout au Panier</button>
        </div>
    </div>
