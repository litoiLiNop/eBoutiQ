...
@endphp --}}
 ...
 {{-- <a href="index.html" class="mb-15"><img src="{{ asset($setting->logo) }}" alt="logo" /></a> --}}
                                <p class="font-lg text-heading">SuperMarché De Chez Soi</p>
                            </div>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; 2022, <strong class="text-brand">eBoutiQ</strong> - Supermarch"s au Cameroun <br />All rights reserved</p>
                    {{-- <p class="font-sm mb-0"> <strong class="text-brand">eBoutiQ</strong> - {{ $setting->copyright }}</p> --}}
                </div>
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">

                    {{-- <div class="hotline d-lg-inline-flex">
                        <img src="{{ asset('frontend/assets/imgs/theme/icons/phone-call.svg') }}" alt="hotline" />
                        <p>{{ $setting->phone_one }}<span>24/7 Service Clientèle</span></p>
                    </div> --}}
                    <div class="hotline d-lg-inline-flex">
                        <img src="{{ asset('frontend/assets/imgs/theme/icons/phone-call.svg') }}" alt="hotline" />
                        <p>(+237)1522<span>24/7 Support Center</span></p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                    ...
                    <p class="font-sm">Plus de 15% de réduction llors de votre votre souscription</p>
                </div>
            </div>
        </div>
    </footer>
