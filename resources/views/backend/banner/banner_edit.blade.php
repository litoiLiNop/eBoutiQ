...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Editer la Bannière </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Editer la Bannière </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
	...
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('update.banner') }}" enctype="multipart/form-data" >
		 ...
		 <input type="hidden" name="old_img" value="{{ $banner->banner_image }}">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Lien de la Bannière </h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Bannière Image   </h6>
				</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ asset($banner->banner_image) }}" alt="Banière" style="width:100px; height: 100px;"  >
				</div>
			</div>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                banner_title: {
                    required : 'Renseigner le titre de la bannière',
                },
                banner_url: {
                    required : 'Renseigner le lien de la bannière ',
                },
            },
            errorElement : 'span',
