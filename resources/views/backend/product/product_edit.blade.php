					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Editer Produit</li>
							</ol>
						</nav>
					</div>
...
<form id="myForm" method="post" action="{{ route('update.product') }}"  >
	    ...
	    <div class="row">
           ...
           <div class="border border-3 p-4 rounded">
            ...
            <div class="mb-3">
			  ...
			  <div class="form-group mb-3">
				<label for="inputProductDescription" class="form-label">Sommaire</label>
              ...
              <div class="row g-3">
				...
				<div class="form-group col-md-6">
				  ...
				  <div class="form-group col-12">
					<label for="inputProductType" class="form-label"> Marques</label>
 	...
 	<option value="{{ $brand->id }}" {{ $brand->id == $products->brand_id ? 'selected' : '' }} >{{ $brand->brand_name }}</option>
				  ...
				  <div class="form-group col-12">
					<label for="inputVendor" class="form-label">Catégorie</label>
				  ...
				  <div class="col-12">
					<label for="inputCollection" class="form-label">Choisir un Vendeur</label>
...
<form method="post" action="{{ route('update.product.thumbnail') }}" enctype="multipart/form-data" >
	...
	<div class="card-body">
		<div class="mb-3">
			<label for="formFile" class="form-label">Changer ou conserver l'image </label>
...
<div class="page-content">
	<h6 class="mb-0 text-uppercase">Mettre à jour les images additionnelles </h6>
	<hr>
<div class="card">
<div class="card-body">
	<table class="table mb-0 table-striped">
		<thead>
			<tr>
				...
				<th scope="col">Changer l'image </th>
 ...
 <form method="post" action="{{ route('update.product.multiimage') }}" enctype="multipart/form-data" >
	...
	<a href="{{ route('product.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete" > Supprimer </a>
		</td>
	</tr>
	@endforeach
